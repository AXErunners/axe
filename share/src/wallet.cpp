...
// axe: total coins staked (non-spendable until maturity)
...
// axe: check 'spent' consistency between wallet and txindex
// axe: fix wallet spent state according to txindex
...
// axe: disable transaction (only for coinstake)
