...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 73000, uint256("0x8e10d933a2bb5beeb15006482b3c3bf76348ad0773dc7b809151af1888047a96"))
        ;
    ...
    // axe: synchronized checkpoint (centrally broadcasted)
    ...
    // axe: get last synchronized checkpoint
    ...
    // axe: only descendant of current sync-checkpoint is allowed
    ...
    // axe: reset synchronized checkpoint to last hardened checkpoint
...
// axe: sync-checkpoint master key
...
// axe: verify signature of sync-checkpoint message
...
// axe: process synchronized checkpoint
