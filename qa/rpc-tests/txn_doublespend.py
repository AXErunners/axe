...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 12400 AXE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 AXE coin each
        ...
        # Node0's total balance should be starting balance, plus 1000AXE for
