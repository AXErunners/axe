...
#Set env vars
buildDir = BUILDDIR
if "AXED" not in os.environ:
    os.environ["AXED"] = buildDir + '/src/axed' + EXEEXT
if "AXECLI" not in os.environ:
    os.environ["AXECLI"] = buildDir + '/src/axe-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Axe Core
]
