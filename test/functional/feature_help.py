...
"""Verify that starting axed with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start axed with -h for help text")
        ...
        self.log.info("Start axed with -version for version information")
