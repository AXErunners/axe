...
By default, axed will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give axed a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent axed from writing mempool.dat to disk. Verify that `savemempool` fails")
