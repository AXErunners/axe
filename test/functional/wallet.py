...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 AXE from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 AXE in block rewards plus fees, but
        ...
        # Sendmany 100 AXE with subtract fee from amount
