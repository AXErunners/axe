...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            1581201248, // * UNIX timestamp of last known number of transactions
            613539,    // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            1581200521, // * UNIX timestamp of last known number of transactions
            3849,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
