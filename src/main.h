...
static const int64_t MAX_MONEY = 48927835 * COIN;
...
static const uint256 hashGenesisBlock("0x00000848c4c426413b0a42d4d127085f903670f51aca7b177d2c004867bc50af");
static const uint256 hashGenesisBlockTestNet("0x00000848c4c426413b0a42d4d127085f903670f51aca7b177d2c004867bc50af");
...
public:
    ...
    {
        // axe: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // axe: get transaction coin age
...
public:
    ...
    // axe: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // axe: two types of block: proof-of-work or proof-of-stake
    ...
    // axe: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // axe: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // axe: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // axe: block index flags
    enum
    {
