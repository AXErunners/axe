    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Axe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Axe Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Axe Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Axe Core help message to get a list with possible Axe Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Axe Core client") + " " + networkStyle->getTitleAddText();
