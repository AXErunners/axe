    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Axe Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Axe Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  axe-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Axe in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AXE, 0.1 AXE, 1 AXE and 10 AXE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://axepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://axepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Axe Core is shutting down...") + "<br /><br />" +
