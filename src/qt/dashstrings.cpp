...
QT_TRANSLATE_NOOP("axe-core", "%d of last 100 blocks have unexpected version"),
...
QT_TRANSLATE_NOOP("axe-core", "-litemode is deprecated."),
...
QT_TRANSLATE_NOOP("axe-core", "Create up to N inputs of each denominated amount (%u-%u, default: %u)"),
QT_TRANSLATE_NOOP("axe-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("axe-core", "Disable governance validation (0-1, default: %u)"),
...
QT_TRANSLATE_NOOP("axe-core", "Error loading %s: You can't disable HD on an already existing HD wallet"),
QT_TRANSLATE_NOOP("axe-core", "Error loading block database"),
QT_TRANSLATE_NOOP("axe-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
...
QT_TRANSLATE_NOOP("axe-core", "Error upgrading evo database"),
...
QT_TRANSLATE_NOOP("axe-core", "Error: failed to add socket to epollfd (epoll_ctl returned error %s)"),
QT_TRANSLATE_NOOP("axe-core", "Exceeded max tries."),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear fulfilled requests cache at"),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear governance cache at"),
QT_TRANSLATE_NOOP("axe-core", "Failed to clear masternode cache at"),
QT_TRANSLATE_NOOP("axe-core", "Failed to commit EvoDB"),
...
QT_TRANSLATE_NOOP("axe-core", "Failed to rescan the wallet during initialization"),
...
QT_TRANSLATE_NOOP("axe-core", "Inputs vs outputs size mismatch."),
...
QT_TRANSLATE_NOOP("axe-core", "Invalid amount for -discardfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("axe-core", "Invalid masternodeblsprivkey. Please see documentation."),
...
QT_TRANSLATE_NOOP("axe-core", "It has been replaced by -disablegovernance."),
QT_TRANSLATE_NOOP("axe-core", "Its replacement -disablegovernance has been forced instead."),
...
QT_TRANSLATE_NOOP("axe-core", "Not enough funds to mix."),
...
QT_TRANSLATE_NOOP("axe-core", "Prune mode is incompatible with -disablegovernance=false."),
...
QT_TRANSLATE_NOOP("axe-core", "Replaying blocks..."),
...
QT_TRANSLATE_NOOP("axe-core", "Send reject messages per BIP61 (default: %u)"),
...
QT_TRANSLATE_NOOP("axe-core", "Socket events mode, which must be one of: %s (default: %s)"),
QT_TRANSLATE_NOOP("axe-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("axe-core", "Specified -walletdir \"%s\" is a relative path"),
QT_TRANSLATE_NOOP("axe-core", "Specified -walletdir \"%s\" is not a directory"),
...
QT_TRANSLATE_NOOP("axe-core", "Start PrivateSend automatically (0-1, default: %u)"),
QT_TRANSLATE_NOOP("axe-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("axe-core", "Submitted to masternode, waiting in queue %s"),
QT_TRANSLATE_NOOP("axe-core", "Sync mempool from other nodes on start (default: %u)"),
...
QT_TRANSLATE_NOOP("axe-core", "Target PrivateSend balance (%u-%u, default: %u)"),
...
QT_TRANSLATE_NOOP("axe-core", "This is expected because you are running a pruned node."),
...
QT_TRANSLATE_NOOP("axe-core", "Unable to generate initial keys"),
...
QT_TRANSLATE_NOOP("axe-core", "Unsupported logging category %s=%s."),
...
QT_TRANSLATE_NOOP("axe-core", "Verifying wallet(s)..."),
QT_TRANSLATE_NOOP("axe-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("axe-core", "Wallet %s resides outside wallet directory %s"),
...
QT_TRANSLATE_NOOP("axe-core", "You are starting with governance validation disabled."),
QT_TRANSLATE_NOOP("axe-core", "You can not disable governance validation on a masternode."),
QT_TRANSLATE_NOOP("axe-core", "You can not start a masternode with wallet enabled."),
QT_TRANSLATE_NOOP("axe-core", "You need to rebuild the database using -reindex to change -addressindex"),
QT_TRANSLATE_NOOP("axe-core", "You need to rebuild the database using -reindex to change -spentindex"),
QT_TRANSLATE_NOOP("axe-core", "You need to rebuild the database using -reindex to change -txindex"),
