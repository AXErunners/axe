This directory contains the AxeQT graphical user interface (GUI). It uses the cross platform framework [QT](https://www1.qt.io/developers/).
...
Represents the main window of the Axe UI.
...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following an axe:... link from a browser).
...
* don't change `local/axe_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
...
10. Start debugging with Qt Creator (you might need to the executable to "axe-qt" under "Run", which is where you can also add command line arguments)
