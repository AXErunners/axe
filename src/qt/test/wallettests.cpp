...
//
//     src/qt/test/test_axe-qt -platform xcb      # Linux
//     src/qt/test/test_axe-qt -platform windows  # Windows
//     src/qt/test/test_axe-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: axe:")) != -1);
