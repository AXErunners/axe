...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 9)
        throw std::runtime_error(
            ...
            "7. \"use_ps\"             (bool, optional, default=false) Use fully mixed funds only\n"
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 10)
        throw std::runtime_error(
            ...
            "8. \"use_ps\"                (bool, optional, default=false) Use fully mixed funds only\n"
...
UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"privatesend_balance\": xxxxxx, (numeric) the fully mixed axe balance of the wallet in " + CURRENCY_UNIT + "\n"
