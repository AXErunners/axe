 ...
 *
 *   // network
 *   CAxeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.axe.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAxeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AxeNetwork
// //   -- signature requirements : Key1(User)
// class CAxeNetworkVariable : public CGovernanceObject
// {
// private:
