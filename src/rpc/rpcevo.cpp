...
void protx_register_fund_help()
{
    throw std::runtime_error(
            ...
            "is fully deployed.\n"
            "\nArguments:\n"
            "1. \"collateralAddress\"   (string, required) The axe address to send the collateral to.\n"
            ...
            "7. \"payoutAddress\"       (string, required) The axe address to use for masternode reward payments.\n"
...
void protx_update_registrar_help()
{
    throw std::runtime_error(
            ...
            "4. \"payoutAddress\"       (string, required) The axe address to use for masternode reward payments\n"
