...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Axe features */
    { "axe",               "masternode",             &masternode,             true  },
    { "axe",               "masternodelist",         &masternodelist,         true  },
    { "axe",               "masternodebroadcast",    &masternodebroadcast,    true  },
    { "axe",               "gobject",                &gobject,                true  },
    { "axe",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "axe",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "axe",               "voteraw",                &voteraw,                true  },
    { "axe",               "mnsync",                 &mnsync,                 true  },
    { "axe",               "spork",                  &spork,                  true  },
    { "axe",               "getpoolinfo",            &getpoolinfo,            true  },
    { "axe",               "sentinelping",           &sentinelping,           true  },
#ifdef ENABLE_WALLET
...
{
    return "> axe-cli " + methodname + " " + args + "\n";
}
