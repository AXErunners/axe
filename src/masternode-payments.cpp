...
*
*   Why is this needed?
*   - In AXE some blocks are superblocks, which output much higher amounts of coins
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew) const
{
    ...
    LogPrintf("CMasternodeBlockPayees::IsTransactionValid -- ERROR: Missing required payment, possible payees: '%s', amount: %f AXE\n", strPayeesPossible, (float)nMasternodePayment/COIN);
    return false;
}
