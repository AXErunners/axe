...
def setup():
    ...
    if not os.path.isdir('axe-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/axerunners/axe-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('axe'):
        subprocess.check_call(['git', 'clone', 'https://github.com/axerunners/axe.git'])
...
def build():
    ...
    os.makedirs('axe-binaries/' + args.version, exist_ok=True)
    ...
    subprocess.check_call(['make', '-C', '../axe/depends', 'download', 'SOURCES_PATH=' + os.getcwd() + '/cache/common'])
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/axe-*.tar.gz build/out/src/axe-*.tar.gz ../axe-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/axe-*-win-unsigned.tar.gz inputs/axe-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/axe-*.zip build/out/axe-*.exe ../axe-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/axe-*-osx-unsigned.tar.gz inputs/axe-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/axe-*.tar.gz build/out/axe-*.dmg ../axe-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/axe-*win64-setup.exe ../axe-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/axe-*win32-setup.exe ../axe-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/axe-osx-signed.dmg ../axe-binaries/'+args.version+'/axe-'+args.version+'-osx.dmg', shell=True)
...
def verify():
    ...
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../axe/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../axe/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../axe/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../axe/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../axe/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/axerunners/axe', help='Specify the URL of the repository. Default is %(default)s')
    ...
    if args.pull:
        ...
        os.chdir('../gitian-builder/inputs/axe')
        subprocess.check_call(['git', 'fetch', args.url, 'refs/pull/'+args.version+'/merge'])
