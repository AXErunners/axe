# Linearize
Construct a linear, no-fork, best version of the Axe blockchain. The scripts
...
JSON-RPC server. Running `axed` or `axe-qt -server` will be sufficient.
...
* `input`: axed blocks/ directory containing blkNNNNN.dat
